...
- **CASE_ID (assigned live):** CEDX-7F3A  _(placeholder — replace with the live-assigned id)_
...
```
- **My role R:** risk_officer   _(for placeholder CEDX-7F3A; recomputed at runtime from real CASE_ID)_
- **My threshold T:** 26000
